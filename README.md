...
Our trace files can be downloaded from “[pkttrace](https://zenodo.org/records/14990444)”.

To run LR-FHSS-receiver, MATLAB is needed, along with the some toolboxes: such as Communications Toolbox, Signal Processing Toolbox, DSP System Toolbox, LTE Toolbox and Fixed-Point Designer Toolbox
...
Revised and edited by tanios9601 on the 5th of March, 2026.
